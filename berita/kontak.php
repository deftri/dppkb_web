...
// Query untuk mengambil data footer (informasi kontak)
...
<section class="content-section bg-light">
    <div class="container text-center">
        ...
        <p><strong>Email:</strong> <?php echo htmlspecialchars($footer['email']); ?></p>
        <p><strong>Telepon:</strong> <?php echo htmlspecialchars($footer['telepon']); ?></p>
        <p><strong>Alamat:</strong> <?php echo htmlspecialchars($footer['alamat']); ?></p>
